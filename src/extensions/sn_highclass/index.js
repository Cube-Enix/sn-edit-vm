            ...
            blocks: [
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        default:
                            "Alert Message [title] with description [desc] type: [type]",
                        description:
                            "Block that returns the last key that was pressed",
                    }),
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        description:
                            "Block that returns if two values are the same. Case Senstive",
                    }),
                    blockType: BlockType.BOOLEAN,
                    arguments: {
                        A: {
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        description:
                            "Block that returns if one value contains the other. Case sensitive.",
                    }),
                    blockType: BlockType.BOOLEAN,
                    arguments: {
                        A: {
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        default: "[A] <= [B]",
                        description:
                            "Block that returns if one value is less than or equal to another value",
                    }),
                    blockType: BlockType.BOOLEAN,
                    arguments: {
                        A: {
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        default: "[A] >= [B]",
                        description:
                            "Block that returns if one value is greater than or equal to another value",
                    }),
                    blockType: BlockType.BOOLEAN,
                    arguments: {
                        A: {
...

                {
                    ...
                    text: formatMessage({
                        ...
                        default:
                            "Edit Object: [obj] Name: [name] Value: [value]",
                    }),
                    arguments: {
                        obj: {
                            type: ArgumentType.STRING,
...

                {
                    ...
                    text: formatMessage({
                        ...
                        default: "Object Value: [obj] Name: [name]",
                    }),
                    arguments: {
                        obj: {
                            type: ArgumentType.STRING,
