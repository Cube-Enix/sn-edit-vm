 ...
 */
 ...
 class hash {
            ...
            blocks: [
                {
                    ...
                    text: formatMessage({
                        ...
                        default: 'Aes256 Encypt Text [TEXT] key [KEY]',
                        description: 'Encypt'
                    }),
                ...
                },
                {
                    ...
                    text: formatMessage({
                        id: 'sn.blocks.playsound',
                        default: 'Aes256 decypt data [TEXT] key [KEY]',
    ...
    DENCAES256(args){
        return CryptoJS.AES.decrypt(args.text, args.KEY).toString(CryptoJS.enc.Utf8);
    }
